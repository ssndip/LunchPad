                        ...
                        <div className="flex justify-between items-start gap-4 mb-4">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <button
                              ...
                              className="w-10 h-10 flex items-center justify-center bg-red-50 text-red-500 rounded-xl hover:bg-red-100 active:scale-90 transition-all shrink-0 focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-900"
                              title={t("modals.remove")}
                              aria-label={`${t("modals.remove")} ${item.name}`}
                            >
                ...
                <div className="flex justify-between items-start gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="ml-1 w-8 h-8 flex items-center justify-center text-neutral-300 hover:text-red-500 hover:bg-red-50 rounded-lg transition-all active:scale-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-900"
                      title={t("modals.remove")}
                      aria-label={`${t("modals.remove")} ${item.name}`}
                    >
