                      ...
                      <tr key={card.rfid} className="hover:bg-neutral-50 transition-colors">
                        ...
                        <td className="p-6 text-center">
                          <button
                            ...
                            className={`w-12 h-6 rounded-full transition-all mx-auto relative focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:ring-neutral-900 ${values.isAdmin ? 'bg-neutral-900' : 'bg-neutral-200'}`}
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 py-1">
                <button
                  ...
                  className={`w-12 h-6 rounded-full transition-all relative focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:ring-neutral-900 ${newCardIsAdmin ? 'bg-neutral-900' : 'bg-neutral-200'}`}
