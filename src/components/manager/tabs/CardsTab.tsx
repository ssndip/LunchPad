            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse min-w-[500px]">
                ...
                <tbody className="divide-y divide-neutral-100">
                  ...
                  className={`w-12 h-6 rounded-full transition-all mx-auto relative focus:outline-none ${values.isAdmin ? 'bg-neutral-900' : 'bg-neutral-200'} focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-neutral-900`}
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 py-1">
                <button
                  ...
                  className={`w-12 h-6 rounded-full transition-all relative focus:outline-none ${newCardIsAdmin ? 'bg-neutral-900' : 'bg-neutral-200'} focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-neutral-900`}
