                ...
                <thead>
                  <tr>
                    {[
                      ...
                      <th
                        key={h}
                        className={`p-6 font-serif italic text-xs uppercase tracking-widest text-neutral-400 border-b border-neutral-100 ${[2, 3, 4].includes(i) ? "text-center" : ""}`}
                      >
                        {h}
                      </th>
                    ))}
                    ...
                    cards.map((card) => (
                      ...
                      >
                        ...
                        <td className="p-6 text-center">
                          ...
                          >
                            <div
                              className={`absolute top-0.5 w-5 h-5 bg-white rounded-full transition-all ${card.isAdmin ? "left-[1.65rem]" : "left-0.5"}`}
                            />
                          </button>
                        </td>
                        <td className="p-6 text-center">
                        ...
                        <td className="p-6">
                          <div className="flex items-center justify-center gap-2">
                            <button
                              onClick={() => onResetCardBalance(card.rfid)}
                            ...
                            <button
                              onClick={() => onRemoveCard(card.rfid)}
                              className="p-2 hover:bg-neutral-100 rounded-lg text-neutral-400 hover:text-red-600 transition-colors"
          ...
          <div className="bg-white p-6 rounded-3xl border border-neutral-200 shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 py-1">
                ...
                >
                  <div
                    className={`absolute top-0.5 w-5 h-5 bg-white rounded-full transition-all ${newCardIsAdmin ? "left-[1.65rem]" : "left-0.5"}`}
                  />
                </button>
