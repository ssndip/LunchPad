      ...
      <div className="bg-white rounded-3xl shadow-sm border border-neutral-200 overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse min-w-[500px]">
            <thead>
              <tr>
                <th className="p-6 font-serif italic text-xs uppercase tracking-widest text-neutral-400 border-b border-neutral-100">
                  {t("orders.date")}
                </th>
                <th className="p-6 font-serif italic text-xs uppercase tracking-widest text-neutral-400 text-center border-b border-neutral-100">
                  {t("navigation.order_summary")}
                </th>
                <th className="p-6 font-serif italic text-xs uppercase tracking-widest text-neutral-400 text-right border-b border-neutral-100">
                  {t("orders.total")}
                </th>
              </tr>
            </thead>
                    ...
                    >
                      <td className="p-6 font-bold text-neutral-900">
                        <div className="flex items-center gap-3">
                          <div
                            className={`w-8 h-8 rounded-lg flex items-center justify-center transition-all ${expandedDate === summary.date ? "bg-neutral-900 text-white" : "bg-neutral-100 text-neutral-400 group-hover:bg-neutral-200"}`}
                          >
                            <ChevronRight
