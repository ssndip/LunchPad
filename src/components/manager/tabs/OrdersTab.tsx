...
export const OrdersTab: React.FC<OrdersTabProps> = ({
  ...
  // Extracted so it can render either under a phone card or inside the
  // table's colSpan row — DataList decides which, this just returns the
  // content either way.
  const renderBreakdown = (summary: DailySummary) => (
    <motion.div
    ...
    >
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
        ...
        <div className="flex flex-col md:flex-row md:flex-wrap md:items-center gap-4">
          ...
          <div className="flex flex-col md:flex-row md:items-end gap-2 md:h-12 w-full md:w-auto md:mt-auto">
            <button
              onClick={(e) => {
                e.stopPropagation();
